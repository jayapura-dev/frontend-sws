            ...
            <div class="col-sm-12 col-md-12 col-lg-12 mt-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" class="form-control" value="https://api.infocoronapapua.com" id="url1" readonly="true" /> 
                            </div>
                            <button onclick="copy_url()" class="btn btn-sm btn-primary btn-action">Copy</button>
                        </div>
                        <br/>
                        <p>SAMPLE RESPONSE :</p>
...
<script type="text/javascript">
  function copy_url(){
    document.getElementById("url1").select();
